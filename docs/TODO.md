...
**✅ 최근 완료:**
- 데이터 영속성 구현 (SharedPreferences + Firestore) - 100% 완료 (2026-01-18)
- 텍스트 마크업 파싱 구현 (6가지 문법) - 100% 완료 (2026-01-18)
- JSON Import 기능 (학습 콘텐츠 + 퀴즈) - 100% 완료 (2026-02-06)
- API 키 보안 설정 (.gitignore 적용) - 100% 완료 (2026-02-15)
...
### 백오피스 (2026-01-04 ~ 2026-02-06 완료)
- [x] Next.js 15 기반 웹 백오피스
- [x] WYSIWYG 에디터 (학습 콘텐츠)
- [x] 모바일 실시간 프리뷰
- [x] 마크업 파서 (6가지 문법)
- [x] Firestore 연동
- [x] JSON Import 기능 (학습 콘텐츠 + 퀴즈) (2026-02-06)
...
**✅ 이미 완료:**
- 데이터 영속성 구현 (SharedPreferences + Firestore) (2026-01-18)
- 텍스트 마크업 파싱 구현 (6가지 문법) (2026-01-18)
- JSON Import 기능 구현 (2026-02-06)
- API 키 보안 설정 (2026-02-15)
...
**작성일:** 2026-01-18 (업데이트: 2026-02-15)
**마일스톤:** MVP v1.0 출시
