...
#### 캐릭터 애니메이션 (10개 상태, 프레임 기반)
- [x] **기술 스택 변경** 🔄 Rive → PNG 프레임 시퀀스 (Midjourney Video)
- [x] **개발 완료** (2025-12-23)
...
- [ ] **디자인팀 작업 대기** 🔴 애니메이션 제작 필요 (39개)

**상태 체계 (2025-12-23 재설계):**
- 카테고리 1: 캐릭터 선택 화면 (2개)
  - `greeting`: 손 흔들며 인사 (125 frames, 5.2초) - 헌터캣 완료 ✅
  - `selected`: 선택됨 반응 (20 frames, 0.8초) - 헌터캣 완료 ✅
- 카테고리 2: 범용 상태 (4개)
  - `idle`: 조용한 대기 - 복합 애니메이션 (120 frames, 5초) 🆕
  - `thinking`: 퀴즈 문제 표시 (24 frames, 1초)
  - `happy`: 정답/긍정 피드백 (30 frames, 1.2초)
  - `confused`: 오답/부정 피드백 (20 frames, 0.8초)
- 카테고리 3: 홈 화면 전용 (4개) 🆕
  - `home_studying`: 책 읽기 (60 frames, 2.5초)
  - `home_excited`: 활기찬 모습 (48 frames, 2초)
  - `home_sleepy`: 졸린 모습 (72 frames, 3초)
  - `home_celebration`: 목표 달성 (36 frames, 1.5초)

> **애니메이션 현황**:
> - ✅ AnimatedCharacter 위젯 완성 (개발팀)
> - ✅ 프레임 시스템 구축 완료
> - 🔴 디자인팀: 39개 애니메이션 제작 대기 (10개 상태 × 4개 캐릭터 - 헌터캣 2개 완료)
